...
### API Endpoints
  ...
  * **Retrieves all companies**
      ...
      **Description of URL**
    ```sh
    $ https://arcane-reaches-36349.herokuapp.com/companies
    ```
    **Method:**
    `GET`
...
* **Retrieves a individual company based on id**
    ...
    **Description of URL**
    ...
    ```sh
    $ https://arcane-reaches-36349.herokuapp.com/company/:id
    ```
    **Method:**
    `GET`
...
* **Update details of a company**
    ...
    **Description of URL**
    ...
    ```sh
    $ curl --request PUT --url 'https://arcane-reaches-36349.herokuapp.com/company' --header 'content-type: application/json' --data '{"company":{"company_id": 6,"name": "Dell","address": "Brigade Road","city": "Bengaluru","country": "India","email":"dell@123.com","phone_number":123467890,"directors":["Tilak Doddapeni","Rekha Warrier","Vidya Laxman","Tom Higgins"],"owners":["Sanjeev Kumar","Prajwal Halwai","Pooja Gee"]}}' --include
    ```
...
* **Add new company**
    ...
    **Description of URL**
     ...
     ```sh
     $ curl --request POST --url 'https://arcane-reaches-36349.herokuapp.com/company' --header 'content-type: application/json' --data '{"company":{"company_id": 6,"name": "Dell","address": "Brigade Road","city": "Bengaluru","country": "India","email":"dell@123.com","phone_number":123467890,"directors":["Tilak Doddapeni","Rekha Warrier","Vidya Laxman","Tom Higgins"],"owners":["Sanjeev Kumar","Prajwal Halwai","Pooja Gee"]}}' --include
    ```
